...
import algorithm.guoqijun.javaleetcode.been.Info;
import algorithm.guoqijun.javaleetcode.custom.CustomViewPager;
import algorithm.guoqijun.javaleetcode.custom.RadarViewGroup;
import algorithm.guoqijun.javaleetcode.utils.FixedSpeedScroller;
import algorithm.guoqijun.javaleetcode.utils.ZoomOutPageTransformer;

/**
 * Created by GUOQIJUN on 2016/8/6.
 */
public class CityFriend extends Activity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctivity_cityfriend);
        initView();
        initData();
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(CityFriend.this, new AccelerateInterpolator());
...
//            LogUtil.m("位置 " + mPosition);
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            //设置一大堆演示用的数据，麻里麻烦~~
            View view = LayoutInflater.from(CityFriend.this).inflate(R.layout.viewpager_layout, null);
            ...
            ivPortrait.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(CityFriend.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
                }
            });
